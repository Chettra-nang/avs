#!/usr/bin/env python3
"""
Scenario 4: Aggressive Driving Behaviors
Scenario with aggressive neighboring vehicles exhibiting risky behaviors.
Collects complete multimodal dataset with 1000 episodes for safety analysis.
"""
...
def main():
    """Collect data for aggressive driving behaviors scenario."""
    logger.info("Starting Scenario 4: Aggressive Driving Behaviors data collection")
    
    # Storage configuration
    storage_path = Path("/home/chettra/ITC/Research/AVs/data/scenario_04_aggressive_behaviors")
    ...
    collection_config = {
        ...
        "scenarios": ["aggressive_neighbors"],
        "base_seed": 4001,
        "batch_size": 15
    }
    ...
    logger.info(f"  - Scenario: Aggressive Neighbors (50 vehicles, 4 lanes)")
    ...
    try:
        ...
        # Report results
        logger.info("=" * 60)
        logger.info("COLLECTION COMPLETED - SCENARIO 4")
        logger.info("=" * 60)
        ...
        logger.info("Scenario 4 data collection completed successfully!")
